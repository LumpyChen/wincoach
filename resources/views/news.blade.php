		...
		<div class="news-1">
			<div class="news-sec-left">
				...
				<div class="news-text-big">
					<p><a href="{{ URL('article/'.$news->id) }}">{{ $news->title }}</a></p>
						...
						<div class="panel-body" id="panel-b">
							...
							<ul class="newlist">
								<dl>
									...
									<dt><a href="{{ URL('article/'.$news->id) }}">{{ $news->title }}</a></dt>
									@endforeach
									<dd>
							...
							<div class="pictures">
								...
								<div id="pictures-{{ $news->num }}">
									...
									<span class="pictures-span"><a href="{{ URL('article/'.$news->id) }}">{{ $news->title }}</a></span>
